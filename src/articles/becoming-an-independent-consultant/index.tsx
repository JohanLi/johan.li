...
export default function Article() {
  return (
    <ArticleLayout metadata={metadata}>
      <P>
        As 2021 approached, I experienced burnout for the first time in my
        10-year career. Working for a startup, the expectations we set on
        ourselves had spiraled out of control.
      </P>
      <P>
      ...
      <P>
        ...
        clear the latter is less unrealistic and involves more work aligning
        with my interests.
      </P>
      <P>
      ...
      <P>
        ...
        need to track. At worst, you’ll have to log your hours using something
        resembling a college project from a decade ago.
      </P>
      <P>
        As an independent consultant, you trade off stability. Someone can fire
        you in the blink of an eye. Survive a bus hitting you, and you won’t
        have colleagues covering for you as you recuperate.
      </P>
      <P>
        But you can earn much more. You’re paid more for every hour’s work and
        pay less tax by essentially splitting your income in two:
      </P>
      <Ul>
      ...
      <P>
        ...
        such as project size and length. Is a deadline set? Do you decide your
        schedule, and can work be done at your own office? Do you have multiple
        clients simultaneously, and is there an agency involved?
      </P>
      <P>
      ...
      />
      <P>
        A company might have codebases that its developers don’t want to touch
        for one reason or another. So they get contractors to maintain them,
        reducing employee attrition. A studio might have a new game blow up
        overnight. They then fly in consultants to solve scaling issues both
        near-term and long-term.
      </P>
      <P>
        Contractors build according to specifications. They maintain systems and
        augment existing staff. Consultants tend to design and work on
        objectives.
      </P>
      ...
      <P>
        If you end up in the first category, you’ll be drowning in mindless
        work. You couldn’t care less about the product. The client is
        shorthanded because they don’t value people and foster a toxic
        environment. Oh, and their software is a mess too.
      </P>
      <P>
      ...
      <P>
        On the plus side, I’ve worked for three years at Paradox Interactive.
        It’s a well-known gaming company, meaning many developers and hiring
        managers will recognize it. On the negative side, my latest employer is
        relatively unknown as they provide a closed platform to enterprises.
      </P>
      <P>
        ...
        text editors. My last job involved a broad role, with the domain
        addition of SSO. The lack of a common thread can be both a plus and a
        minus.
      </P>
      <P>
        ...
        large organization to look at it, someone at a small company might.
      ...
      <P>
        ...
        at the AWS console. I can do frontend work and create an acceptable user
        interface. I communicate well with developers and non-technical
        stakeholders and involve others in designs. I can do these things, but
        certainly not at the same level as someone dedicated in one area.
      </P>
      <P>
      ...
      <P>
        Down the line, however, I do wonder whether I’ll need to specialize
        more. The deliberation is probably pointless right now, and it’s best to
        evaluate as I go along.
      </P>
      <H3>Read more</H3>
      <div className="text-sm">
        <P>
          Detailed, practical guides about pursuing the independent path:
        </P>
      </div>
      <UlReferences>
        <li>
        ...
        <li>
          <Link
            href="https://github.com/nabati/freelancing-in-sweden"
            external
          />
        </li>
      </UlReferences>
