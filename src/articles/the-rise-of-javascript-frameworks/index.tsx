...
export default function Article() {
  return (
    <ArticleLayout metadata={metadata}>
      <P>
        Google released <strong>Angular</strong> in 2010. It marked the start of
        a revolution in web development, giving a rapid rise to the popularity
        of JavaScript frameworks. In addition to Angular, <strong>React</strong>
      ...
      <P>
        ...
        although static, could link to each other through the use of anchor
        tags.
      </P>
      <P>
        The Internet took off. A browser war started brewing between Netscape
        and Internet Explorer. To gain the upper hand, Netscape introduced
        JavaScript in 1995, paving the way for dynamic behavior on HTML pages.
        Web developers could now implement drop-down menus, alert dialogs, and
        form validation.
      </P>
      <P>
      ...
      <P>
        One of the first websites to roll out a cross-browser implementation of
        it was Gmail when it launched in 2004. To delete an email, we no longer
        had to reload our inbox. And while the request was pending, our browser
        didn’t freeze up, giving us the freedom to view other emails.
      </P>
      <P>
      ...
      <P>
        ...
        information locally. Is the user logged in? What is their name and the
        URL to their profile picture? What data have we loaded from an API? Are
        we still loading that data? Are they viewing a profile page right now,
        and whose?
      </P>
      <P>
      ...
      <P>
        ...
        bare-bones chat application without a JavaScript framework. Focusing
      ...
      />
      <P>
        It carries several drawbacks: the server sends redundant data, users
        need to refresh to see updates, and the browser has to render everything
        for every update.
      </P>
      <P>
        In the first version of our application, we introduce some JavaScript
        that listens to updates from the server. To keep our client simple, it
        will receive updates as an HTML string containing all messages,
        including old ones. Here’s how the DOM manipulation code looks like:
      </P>
      <Code
        language="javascript"
        code={js1}
      ...
      <P>
        ...
        addition to the initial HTML, sends new messages individually. The
        server also adds attributes to the HTML it outputs, allowing our client
      ...
      />
      <P>
        For subsequent messages, the client will add and keep them to 20 at
        most, while handling author names:
      </P>
      <Code
        language="javascript"
        code={javascript1}
      ...
      />
      <P>
        By adding some code, we’ve minimized the amount of re-rendering needed
      ...
      <P>
        As we saw in the second version of our application, to reduce
        re-renders, we had to write code to transform the DOM. If we were to
        implement a feature-rich chat, we would end up with copious amounts of
        code.
      </P>
      <P>
      ...
      <P>
        ...
        describing how they are carried out, we describe <strong>what</strong>{' '}
        the HTML will be in different circumstances. The framework will then,
        under the hood, determine an{' '}
      ...
      <P>
        ...
        change the HTML. Instead, React requires us to define what variables
        make up the state. In our case, the state is simply the messages array.
      </P>
      <P>
