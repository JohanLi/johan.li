...
export default function Article() {
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <P>
        Enter the JavaScript SDK for Microsoft Azure’s Blob Storage.
        Particularly v10, which was the latest version until 2020. Its
      ...
      <P>
        ...
        you upload are called Blobs, and a Blob belongs to a Container.
      </P>
      <P>
        Microsoft provides SDKs in a handful of languages, wrapping the
      ...
      <P>
        I don’t want to sound ungrateful — I’d rather have this than nothing.
        But it wouldn’t be outlandish to assume that people seeking an SDK for a
      ...
      <P>
        ...
        You then want to be able to upload Blobs to them. Contemplate for a
        minute.
      </P>
      <P>
      ...
      <P>
        ...
        impression of forming URLs for you. But, think again — their
        constructors require you to provide the entire URLs yourself. No
        kidding. Additionally, <CodeInline>STORAGE_ACCOUNT_NAME</CodeInline> has
        to be supplied both to <CodeInline>SharedKeyCredential</CodeInline> and{' '}
      ...
      <P>
        ...
        content length being a required argument also feels inconvenient when,
        in most cases, it’s something the SDK can figure out.
      </P>
      <P>
        I’m being harsh. But keep in mind: this is a public SDK wrapping a REST
        API of a widely used service. It’s in its tenth major version. How is
      ...
      <P>
        ...
        the Blob Storage SDK. Other developers chime in, sharing the
        frustration. Here are some highlights from that{' '}
      ...
      <Quote>
        <P>
          The API is an unintuitive mess. Documentation is rubbish and out of
          sync with code, and the example is useless.
        </P>
        <P>
      ...
      <Quote>
        <P>
          ...
          absolutely nothing about what its purpose is. I would think it is
          simply a POJO class for holding some values. The name indicate it is a
          class of values, not a class of functionality.
        </P>
      </Quote>
      ...
      <Quote>
        <P>
          We’ve also been using this (a team of advanced java developers) and
          have been struggling with getting it to work correctly.
        </P>
      </Quote>
      <P>
      ...
      <P>
        Finally, the original poster drops the mic explaining what he expects
        from an SDK:
      </P>
      <Quote>
        <P>
      ...
      <P>
        Preach brother, preach! Give this man a gold star! And he’s even thrown
        in a subtle pigeon reference as well!
      </P>
      <P>
      ...
      <P>
        We sometimes miss the forest for the trees. The SDK’s source code
        utilizes many OOP concepts such as interfaces, inheritance, abstract
        classes, factories, and private methods. Yet, it failed with the very
        essence of OOP in terms of its API.
      </P>
      <H3>References</H3>
